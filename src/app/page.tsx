            ...
            <div className="flex overflow-hidden">
                ...
                <main className="flex-1 p-6 overflow-auto max-h-fmax">
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 ml:grid-cols-6 gap-6 mt-4">
                        ...
                        <SongCard type="mix" src="/mixes/mix3.jpeg" name="Daily Mix 3" description="Doja Cat, Ice Spice, Nicki Minaj and more" responsiveSize="md:flex" />
                        <SongCard type="mix" src="/mixes/mix4.jpeg" name="Daily Mix 4" description="Grim Salvo, Witchouse 40k, ITSOKTOCRY and more" responsiveSize="lg:flex" />
                        <SongCard type="mix" src="/mixes/mix5.jpeg" name="Daily Mix 5" description="LORD$OFDOGTOWN, 99 Neighbors, seeyousoon and more" responsiveSize="xl:flex" />
                        <SongCard
                            type="mix"
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 ml:grid-cols-6 gap-6 mt-4">
                        ...
                        <SongCard type="artist" src="/artists/itsoktocry.jpeg" name="ITSOKTOCRY" description="Artist" responsiveSize="md:flex" />
                        <SongCard type="artist" src="/artists/duckwrth.jpeg" name="Duckwrth" description="Artist" responsiveSize="lg:flex" />
                        <SongCard type="artist" src="/artists/angelus.jpeg" name="angelus" description="Artist" responsiveSize="xl:flex" />
                        <SongCard type="artist" src="/artists/aries.jpeg" name="Aries" description="Artist" responsiveSize="ml:flex" />
                    </div>
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 ml:grid-cols-6 gap-6 mt-4">
                        ...
                        <SongCard type="mix" src="/uniquely_yours/daily_drive.jpg" name="Daily Drive" description="A mix of news and music made for you" responsiveSize="md:flex" />
                        <SongCard type="mix" src="/uniquely_yours/repeat_rewind.jpg" name="Repeat Rewind" description="Your past favorites" responsiveSize="lg:flex" />
                        <SongCard
                            type="mix"
                            src="/uniquely_yours/top_songs2022.jpg"
                            name="Your Time Capsule"
                            description="The songs you loved most this year, all wrapped up."
                            responsiveSize="xl:flex"
                        />
                    </div>
                </main>
            </div>
